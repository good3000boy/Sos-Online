# Generated by Django 3.1 on 2021-02-11 15:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('building', '0002_auto_20210211_1851'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='postbuil',
            name='kind',
            field=multiselectfield.db.fields.MultiSelectField(choices=[('آپارتمان', 'آپارتمان'), ('ویلا', 'ویلا')], default=('آپارتمان', 'آپارتمان'), max_length=13, verbose_name='نوع سازه '),
        ),
