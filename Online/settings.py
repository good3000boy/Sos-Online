...
SECRET_KEY = '4bvuyd3-zv6b)7y!gu6q2gp5+ytm0931@x^9cs+9k7^a3#t3@r'
...
TEMPLATES = [
    {
        ...
        'DIRS': [r'C:\Users\arian\PycharmProjects\pythonProject\djangoProject\djangoProject\Online\Online\accounts\template'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
